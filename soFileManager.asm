    .data
prKeyFile:  .asciiz "_privateKeys.vig"
puKeyFile:  .asciiz "_publicKeys.vig"
srcMessage: .asciiz "_srcMessage .vig"
outMessage: .asciiz "_outMessage .vig"
...
main_retry:
    ...
    la      $a0, outMessage         # output file name
